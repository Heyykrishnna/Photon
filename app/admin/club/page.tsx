...
import { useClubDashboard, useMyClubs } from "@/hooks/api/useClub";
...
function RoleBadge({ role }: { role?: string }) {
  const cfg =
    (role && ROLE_BADGE[role.toUpperCase() as keyof typeof ROLE_BADGE]) ||
    ROLE_BADGE.MEMBER;
  return (
    <Box
      component="span"
