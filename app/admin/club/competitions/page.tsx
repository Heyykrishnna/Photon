...
import { useClubCompetitions } from "@/hooks/api/useClub";
      ...
      >
        ...
        {competitions.length === 0 ? (
          ...
          competitions.map((comp, idx) => {
            const sc =
              STATUS_CONFIG[comp.status as keyof typeof STATUS_CONFIG] ||
              STATUS_CONFIG.DRAFT;
            const ec =
              EVENT_TYPE_CONFIG[
                comp.eventType as keyof typeof EVENT_TYPE_CONFIG
              ...
              <Box key={comp.id}>
                <Box
                  sx={{
                    display: "grid",
                    gridTemplateColumns:
                      "minmax(200px, 1fr) 120px 100px 90px 100px",
                    minWidth: 640,
                    alignItems: "center",
                    px: 3,
                    py: 2,
