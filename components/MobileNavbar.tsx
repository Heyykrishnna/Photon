      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <Noise
              patternAlpha={8}
              className="opacity-30 z-1 pointer-events-none"
            />

            <div className="relative z-10 flex items-center justify-between px-6 pt-10 pb-6 shadow-sm">
              <button
                onClick={onClose}
                className="transition-transform active:scale-90 flex items-center gap-3"
              >
                <Image
            ...
            <div className="flex-1 overflow-y-auto px-10 pt-8 pb-20 relative z-10">
              <div className="space-y-12">
                <div className="grid grid-cols-[60px_1fr] gap-4">
                  <span className="text-white/20 text-[0.7rem] uppercase font-bold pt-4 tracking-[0.3em] [writing-mode:vertical-lr] rotate-180">
                    Discover
                  </span>
                  <motion.div
                    initial="hidden"
                ...
                <div className="grid grid-cols-[60px_1fr] gap-4 mt-8">
                  <span className="text-white/20 text-[0.7rem] uppercase font-bold pt-1 tracking-[0.3em] [writing-mode:vertical-lr] rotate-180">
                    Connect
                  </span>
                  <motion.div
                    initial="hidden"
            ...
            <div className="absolute bottom-10 left-10 z-30">
              <p className="text-[0.6rem] text-white/20 uppercase tracking-[0.4em] font-medium">
                Let's explore the orbit
              </p>
            </div>
          </motion.div>
        </motion.div>
