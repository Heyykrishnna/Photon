...
export default function PlanetDestination({
  ...
  return (
    <motion.main
      ...
      style={{
        background:
          "radial-gradient(circle at 18% 18%,rgba(73,129,255,0.18),transparent 22%),radial-gradient(circle at 82% 24%,rgba(255,158,92,0.16),transparent 18%),linear-gradient(180deg,#040714 0%,#050b18 45%,#040611 100%)",
      }}
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center,transparent 22%,rgba(2,4,10,0.42) 72%),radial-gradient(circle,rgba(255,255,255,0.8) 0.85px,transparent 1.2px)",
          backgroundSize: "auto,180px 180px",
        }}
      />

      <section className="relative z-10 grid min-h-svh items-center gap-12 p-8 md:grid-cols-[minmax(20rem,34rem)_minmax(26rem,42rem)] md:p-12">
        <motion.div
          ...
          <button
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLButtonElement).style.borderColor =
                "rgba(145,191,255,0.32)";
              (e.currentTarget as HTMLButtonElement).style.background =
                "rgba(10,20,41,0.74)";
              (e.currentTarget as HTMLButtonElement).style.boxShadow =
                "0 8px 32px rgba(0,0,0,0.28),0 0 24px rgba(100,170,255,0.1)";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLButtonElement).style.borderColor =
                "rgba(145,191,255,0.2)";
              (e.currentTarget as HTMLButtonElement).style.background =
                "rgba(6,13,28,0.52)";
              (e.currentTarget as HTMLButtonElement).style.boxShadow = "";
            }}
